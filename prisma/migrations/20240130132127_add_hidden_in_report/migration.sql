...
INSERT INTO "new_ReportV2" ("answer", "created", "data", "id", "media_id", "media_source_id", "member_id", "reply_media_id", "status", "type", "updated", "user_id") SELECT "answer", "created", "data", "id", "media_id", "media_source_id", "member_id", "reply_media_id", "status", "type", "updated", "user_id" FROM "ReportV2";
DROP TABLE "ReportV2";
