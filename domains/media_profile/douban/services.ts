...
export type DoubanRequestCommentPart = {
  /** tmdb api key */
  api_key: string;
};
 ...
 * @param keyword
 */
export async function search_tv_in_douban(keyword: string, options: DoubanRequestCommentPart & { page?: number }) {
 ...
 * @param keyword
 */
export async function search_movie_in_tmdb(keyword: string, options: DoubanRequestCommentPart & { page?: number }) {
