...
function hash(e) {
  ...
  //     e = encry2arr_from(e);
  //   }
  const r1 = (0, o_default)(e, 41405);
  //   console.log('r1', r1);
  return to_string.call(r1, 16).replace(/^0+/, "");
  //   return (
  //     "string" == typeof e && (e = encry2arr_from(e)), to_string.call((0, o_default)(e, 41405), 16).replace(/^0+/, "")
  //   );
}
...
function to_string(t) {
  ...
  for (
    ...
    o >= 0 && (div.call(r, e), (n[o] = to_number.call(r.remainder).toString(t)), gt.call(r, e));
    o--
  );
...
function gt(t) {
  return (
    ...
    (!(this._a48 < t._a48) &&
      (this._a32 > t._a32 ||
        (!(this._a32 < t._a32) && (this._a16 > t._a16 || (!(this._a16 < t._a16) && this._a00 > t._a00)))))
  );
}

function div(t) {
  for (var e = clone.call(t), r = -1; !lt.call(this, e); ) shiftLeft.call(e, 1, !0), r++;
  for (this.remainder = clone.call(this), this._a00 = 0, this._a16 = 0, this._a32 = 0, this._a48 = 0; r >= 0; r--)
    shiftRight.call(e, 1),
...
function toByteArray(t) {
  ...
  return (
    2 === a
      ? ((i = (f[t.charCodeAt(e)] << 2) | (f[t.charCodeAt(e + 1)] >> 4)), (s[c++] = 255 & i))
      : 1 === a &&
        ((i = (f[t.charCodeAt(e)] << 10) | (f[t.charCodeAt(e + 1)] << 4) | (f[t.charCodeAt(e + 2)] >> 2)),
        (s[c++] = (i >> 8) & 255),
        (s[c++] = 255 & i)),
    s
  );
...
function o_19(t, e) {
  ...
  return (
    true
      ? ((t = new Uint8Array(e)), (t.__proto__ = Uint8Array.prototype))
...
function write(k, t, e, r, n) {
  ...
  else if (void 0 === r && "string" == typeof e) (n = e), (r = k.length), (e = 0);
  else {
...
function a_slice(k, t, e) {
  // 42  44  46  115  126  132  138  144  148
  var r = k.length;
  (t = ~~t),
    (e = void 0 === e ? r : ~~e),
    ...
    e < t && (e = t);
  var n;
  if (true) (n = k.subarray(t, e)), (n.__proto__ = k.prototype);
  else {
    var o = e - t;
    n = new i(o, void 0);
...
function a_68_copy(k, t, e, r, n) {
  ...
  var o,
    a = n - r;
  if (k === t && r < e && e < n) for (o = a - 1; o >= 0; --o) t[o + e] = k[o + r];
...
function a(e) {
  // 70  92  94
  return "string" == typeof e && (e = t.from(e)), (0, h.default)(e, 41405).toString(16).replace(/^0+/, "");
}
...
function update(kkk, t) {
  ...
  var r,
    o = "string" == typeof t;
  o && ((t = n(t)), (o = !1), (r = !0)),
    "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer && ((r = !0), (t = new Uint8Array(t)));
  var i = 0,
    c = t.length,
    f = i + c;
  if (0 == c) return kkk;
  ...
  if (kkk.memsize > 0) {
    o
      ? (kkk.memory += t.slice(0, 32 - kkk.memsize))
      : r
      ? kkk.memory.set(t.subarray(0, 32 - kkk.memsize), kkk.memsize)
      : t.copy(kkk.memory, kkk.memsize, 0, 32 - kkk.memsize);
    var l = 0;
    if (o) {
      var h;
      (h = a(
        (kkk.memory.charCodeAt(l + 1) << 8) | kkk.memory.charCodeAt(l),
        (kkk.memory.charCodeAt(l + 3) << 8) | kkk.memory.charCodeAt(l + 2),
        (kkk.memory.charCodeAt(l + 5) << 8) | kkk.memory.charCodeAt(l + 4),
        (kkk.memory.charCodeAt(l + 7) << 8) | kkk.memory.charCodeAt(l + 6)
      )),
      ...
      var h;
      (h = a(
        (kkk.memory[l + 1] << 8) | kkk.memory[l],
        (kkk.memory[l + 3] << 8) | kkk.memory[l + 2],
        (kkk.memory[l + 5] << 8) | kkk.memory[l + 4],
        (kkk.memory[l + 7] << 8) | kkk.memory[l + 6]
      )),
        kkk.v1.add(h.multiply(u)).rotl(31).multiply(s),
        (l += 8),
        (h = a(
  ...
  return (
    i < f &&
      (o
        ? (kkk.memory += t.slice(i))
        : r
        ? kkk.memory.set(t.subarray(i, f), kkk.memsize)
        : t.copy(kkk.memory, kkk.memsize, i, f),
      (kkk.memsize = f - i)),
    kkk
  );
}
...
function digest(kkk) {
  ...
  for (
    o + 4 <= i &&
    (n
      ? h.fromBits((r.charCodeAt(o + 1) << 8) | r.charCodeAt(o), (r.charCodeAt(o + 3) << 8) | r.charCodeAt(o + 2), 0, 0)
      : h.fromBits((r[o + 1] << 8) | r[o], (r[o + 3] << 8) | r[o + 2], 0, 0),
    t.xor(multiply(h, s)).rotl(23).multiply(u).add(c),
    (o += 4));
    o < i;

  )
    h.fromBits(n ? r.charCodeAt(o++) : r[o++], 0, 0, 0), t.xor(h.multiply(l)).rotl(11).multiply(s);
  return (
...
function o_default() {
  ...
  if (2 == arguments.length) {
    //     console.log(1);
    const r1 = new o_default(arguments[1]);
    const r2 = arguments[0];
    const r3 = update(r1, r2);
    const r4 = digest(r3);
    return r4;
  }
  if (this instanceof o_default) {
    //     console.log(2);
    return void i_this.call(this, arguments[0]);
  }
  //   console.log(3);
...
function rotl(t) {
  ...
  if (t >= 32) {
    var e = this._a00;
    if (((this._a00 = this._a32), (this._a32 = e), (e = this._a48), (this._a48 = this._a16), (this._a16 = e), 32 == t))
      return this;
    t -= 32;
  }
...
function a_a(t, e, r, n) {
  ...
  return void 0 === r
    ...
    : ((this._a00 = 0 | t), (this._a16 = 0 | e), (this._a32 = 0 | r), (this._a48 = 0 | n), this);
}
...
function add(a, t) {
  ...
  var o = n >>> 16;
  return (
    (o += a._a48 + t._a48), (a._a00 = 65535 & e), (a._a16 = 65535 & r), (a._a32 = 65535 & n), (a._a48 = 65535 & o), a
  );
}
...
function Bt(t) {
  ...
  (e.maxObjectSize = 1e8),
    ...
    (e.parseFile = function (t, e) {
      ...
      return n.isBuffer(t)
        ? r(t)
        : void f.readFile(t, function (t, n) {
...
function u_h_Bt(t, e) {
  return (e = e || 0), readInt32BE.call(t.slice(e, e + 8), 4, 8);
}
...
function kt(t) {
  ...
  function r(t) {
    return "Object" === (0, i.getType)(t)
      ...
      ? (0 === t[t.length - 1] && (t = t.slice(0, t.length - 1)), t.toString())
      : t;
  }
  function o(e) {
...
export function decrypt(r: string): {
  ...
  var u = a.slice(s, s + 16);
  a = Buffer.concat([a.slice(0, s), a.slice(s + 16)]);
  const v = Buffer.concat([u, Buffer.from("")]);
  var c_data = hash(v); // 49  67  69
  var l = {};
  l[c_data] = a;
