...
function add_factory<T extends PrismaClient[ModelKeys]>(
  model: T,
  options: Partial<{ safe: boolean }> = {}
) {
  const { safe } = options;
...
function delete_factory<T extends PrismaClient[ModelKeys]>(model: T) {
  return async (
    search: Parameters<T["update"]>[0]["data"] & { id?: string }
  ) => {
    try {
      // @ts-ignore
...
export function pagination_factory<T extends PrismaClient[ModelKeys]>(
  model: T
) {
  return async (
...
export const store_factory = (prisma: PrismaClient) => {
  return {
    ...
    add_aliyun_drive_token: add_factory<PrismaClient["driveToken"]>(
      prisma.driveToken
    ),
    update_aliyun_drive_token: update_factory<PrismaClient["driveToken"]>(
      prisma.driveToken
    ),
    find_aliyun_drive_token: first_factory<PrismaClient["driveToken"]>(
      prisma.driveToken
    ),
    find_aliyun_drives_token: many_factory<PrismaClient["driveToken"]>(
      prisma.driveToken
    ),
    ...
    find_aliyun_drives_with_pagination: pagination_factory<
      PrismaClient["drive"]
    >(prisma.drive),

    add_async_task: add_factory<PrismaClient["asyncTask"]>(prisma.asyncTask),
    update_async_task: update_factory<PrismaClient["asyncTask"]>(
      prisma.asyncTask
    ),
    ...
    delete_async_task: delete_factory<PrismaClient["asyncTask"]>(
      prisma.asyncTask
    ),
    find_async_task_with_pagination: pagination_factory<
      PrismaClient["asyncTask"]
    >(prisma.asyncTask),

    add_check_in: add_factory<PrismaClient["driveCheckIn"]>(
      prisma.driveCheckIn
    ),
    ...
    find_episodes_with_pagination: pagination_factory<PrismaClient["episode"]>(
      prisma.episode
    ),
    ...
    find_seasons_with_pagination: pagination_factory<PrismaClient["season"]>(
      prisma.season
    ),

    add_history: add_factory<PrismaClient["playHistory"]>(prisma.playHistory),
    update_history: update_factory<PrismaClient["playHistory"]>(
      prisma.playHistory
    ),
    delete_history: delete_factory<PrismaClient["playHistory"]>(
      prisma.playHistory
    ),
    find_history: first_factory<PrismaClient["playHistory"]>(
      prisma.playHistory
    ),
    find_histories: many_factory<PrismaClient["playHistory"]>(
      prisma.playHistory
    ),
    find_history_with_pagination: pagination_factory<
      PrismaClient["playHistory"]
    >(prisma.playHistory),

    add_member_link: add_factory<PrismaClient["memberToken"]>(
      prisma.memberToken
    ),
    update_member_link: update_factory<PrismaClient["memberToken"]>(
      prisma.memberToken
    ),
    delete_member_link: delete_factory<PrismaClient["memberToken"]>(
      prisma.memberToken
    ),
    find_member_link: first_factory<PrismaClient["memberToken"]>(
      prisma.memberToken
    ),
    find_member_links: many_factory<PrismaClient["memberToken"]>(
      prisma.memberToken
    ),
    find_member_link_with_pagination: pagination_factory<
      PrismaClient["memberToken"]
    >(prisma.memberToken),
    ...
    find_member_with_pagination: pagination_factory<PrismaClient["member"]>(
      prisma.member
    ),
    ...
    add_recommended_tv: add_factory<PrismaClient["recommendedTV"]>(
      prisma.recommendedTV
    ),
    update_recommended_tv: update_factory<PrismaClient["recommendedTV"]>(
      prisma.recommendedTV
    ),
    delete_recommended_tv: delete_factory<PrismaClient["recommendedTV"]>(
      prisma.recommendedTV
    ),
    find_recommended_tv: first_factory<PrismaClient["recommendedTV"]>(
      prisma.recommendedTV
    ),
    find_recommended_tvs: many_factory<PrismaClient["recommendedTV"]>(
      prisma.recommendedTV
    ),
    find_recommended_tv_with_pagination: pagination_factory<
      PrismaClient["recommendedTV"]
    >(prisma.recommendedTV),

    add_searched_tv: add_factory<PrismaClient["searchedTV"]>(prisma.searchedTV),
    update_searched_tv: update_factory<PrismaClient["searchedTV"]>(
      prisma.searchedTV
    ),
    find_searched_tv: first_factory<PrismaClient["searchedTV"]>(
      prisma.searchedTV
    ),
    find_searched_tvs: many_factory<PrismaClient["searchedTV"]>(
      prisma.searchedTV
    ),
    find_searched_tv_with_pagination: pagination_factory<
      PrismaClient["searchedTV"]
    >(prisma.searchedTV),

    add_shared_files: add_factory<PrismaClient["sharedFile"]>(
      prisma.sharedFile
    ),
    add_shared_files_safely: async (
      body: Omit<
        Parameters<PrismaClient["sharedFile"]["create"]>[0]["data"],
        "id"
      >
    ) => {
      const { url } = body;
    ...
    update_shared_files: update_factory<PrismaClient["sharedFile"]>(
      prisma.sharedFile
    ),
    delete_shared_files: delete_factory<PrismaClient["sharedFile"]>(
      prisma.sharedFile
    ),
    find_shared_files: first_factory<PrismaClient["sharedFile"]>(
      prisma.sharedFile
    ),
    find_shared_files_list: many_factory<PrismaClient["sharedFile"]>(
      prisma.sharedFile
    ),
    find_shared_files_list_with_pagination: pagination_factory<
      PrismaClient["sharedFile"]
    >(prisma.sharedFile),
    ...
    find_user_with_pagination: pagination_factory<PrismaClient["user"]>(
      prisma.user
    ),
    ...
    find_folder_with_pagination: pagination_factory<PrismaClient["folder"]>(
      prisma.folder
    ),

    add_tmp_folder: add_factory<PrismaClient["tmpFolder"]>(prisma.tmpFolder),
    update_tmp_folder: update_factory<PrismaClient["tmpFolder"]>(
      prisma.tmpFolder
    ),
    delete_tmp_folder: delete_factory<PrismaClient["tmpFolder"]>(
      prisma.tmpFolder
    ),
    ...
    find_tmp_folder_with_pagination: pagination_factory<
      PrismaClient["tmpFolder"]
    >(prisma.tmpFolder),

    add_shared_files_in_progress: add_factory<
      PrismaClient["sharedFileInProgress"]
    >(prisma.sharedFileInProgress),
    update_shared_files_in_progress: update_factory<
      PrismaClient["sharedFileInProgress"]
    >(prisma.sharedFileInProgress),
    delete_shared_files_in_progress: delete_factory<
      PrismaClient["sharedFileInProgress"]
    >(prisma.sharedFileInProgress),
    find_shared_files_in_progress: first_factory<
      PrismaClient["sharedFileInProgress"]
    >(prisma.sharedFileInProgress),
    find_shared_files_list_in_progress: many_factory<
      PrismaClient["sharedFileInProgress"]
    >(prisma.sharedFileInProgress),
    find_shared_files_in_progress_with_pagination: pagination_factory<
      PrismaClient["sharedFileInProgress"]
    >(prisma.sharedFileInProgress),

    add_searched_season: add_factory<PrismaClient["searchedSeason"]>(
      prisma.searchedSeason
    ),
    update_searched_season: update_factory<PrismaClient["searchedSeason"]>(
      prisma.searchedSeason
    ),
    find_searched_season: first_factory<PrismaClient["searchedSeason"]>(
      prisma.searchedSeason
    ),
    find_searched_season_list: many_factory<PrismaClient["searchedSeason"]>(
      prisma.searchedSeason
    ),
    find_searched_season_with_pagination: pagination_factory<
      PrismaClient["searchedSeason"]
    >(prisma.searchedSeason),

    add_tv_need_complete: add_factory<PrismaClient["tVNeedComplete"]>(
      prisma.tVNeedComplete
    ),
    update_tv_need_complete: update_factory<PrismaClient["tVNeedComplete"]>(
      prisma.tVNeedComplete
    ),
    delete_tv_need_complete: delete_factory<PrismaClient["tVNeedComplete"]>(
      prisma.tVNeedComplete
    ),
    find_tv_need_complete: first_factory<PrismaClient["tVNeedComplete"]>(
      prisma.tVNeedComplete
    ),
    find_tv_need_complete_list: many_factory<PrismaClient["tVNeedComplete"]>(
      prisma.tVNeedComplete
    ),
    find_tv_need_complete_with_pagination: pagination_factory<
      PrismaClient["tVNeedComplete"]
    >(prisma.tVNeedComplete),
  };
};
  ...
  return {
    ...
    async fetch_files(id: string, options: { marker?: string } = {}) {
      ...
      const r = await resultify(
        store.prisma.folder.findMany.bind(store.prisma.folder)
      )({
        where: {
          parent_file_id: id,
          drive_id: drive_id,
